...
class Penduduk extends Admin_Controller
{
    ...
    private $Penduduk_log_model;
    private $penduduk_model;
    private $referensi_model;
    private $wilayah_model;
    private $modul_ini;
    private $sub_modul_ini;
    private $controller;
    private $web_dokumen_model;
    private $impor_model;
    private $keluarga_model;
    private $program_bantuan_model;
    private $lapor_model;
    private $ekspor_model;
