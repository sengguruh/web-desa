...
<div class="">
	...
	<div class="single_bottom_rightbar">
		...
		<a href=https://www.openstreetmap.org/export#map=16/-8.1720/112.5512<?=$data_config['lat']."/".$data_config['lng']?>" class="btn btn-primary btn-block" rel="noopener noreferrer" target="_blank">Buka Peta</a>
	</div>
</div>
